  ...
  return (
    ...
    >
          ...
          return (
            <button
              ...
              className={`py-1.5 text-xs font-extrabold uppercase border-[3px] border-black rounded-none transition-all relative cursor-pointer ${
                isActive
                  ? 'bg-[#cc3311] text-white shadow-none translate-y-[2px]'
                  : isLocked
                  ...
                  : 'bg-white hover:bg-[#efebe4] text-black shadow-[2.5px_2.5px_0px_0px_rgba(0,0,0,1)] active:translate-y-[2px] active:shadow-none'
              }`}
            >
              ...
              {!bypassMode && !isLocked && !selectedSubject && tab === 'subject' && (
                <span className="absolute top-1 right-1 w-2 h-2 rounded-full bg-[#cc3311] animate-ping" />
              )}
      ...
      <div className="flex items-center gap-2 border-[2px] border-black py-1 px-2.5 bg-white text-black">
        <span className="w-1.5 h-1.5 rounded-full bg-[#cc3311] animate-pulse shrink-0" />
            ...
            <motion.button
              ...
              className={`group relative flex flex-col items-center justify-center p-2.5 pb-2 rounded-none border-[3px] border-black transition-all duration-150 cursor-pointer ${
                isSelected
                  ...
                  : 'bg-[#efebe4] text-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] dark:shadow-[3px_3px_0px_0px_rgba(255,255,255,0.1)] hover:shadow-none hover:translate-y-[2px]'
              }`}
            >
              {/* Checkmark inside circular badge */}
              {isSelected && (
                <span className="absolute top-1.5 right-1.5 bg-black text-[#cc3311] p-0.5 rounded-full ring-1 ring-white">
